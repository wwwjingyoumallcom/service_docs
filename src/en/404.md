...
<div class="not-found-page">
  ...
  <div class="nf-content">
    ...
    <div class="nf-actions">
      <a href="/docs/en/" class="nf-btn nf-btn--primary">← Back to home</a>
      <a href="javascript:history.back()" class="nf-btn nf-btn--ghost" onclick="if (document.referrer === '') { window.location.href='/docs/en/'; return false; }">Go back</a>
    </div>
  </div>
</div>
